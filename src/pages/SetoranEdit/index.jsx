...
function SetoranEdit() {
    ...
    const handleRemoveDepot = (id) => {
        setDepotList(depotList.filter((item) => item.id !== id));
    };

    const handleDepotChange = (id, field, value) => {
        setDepotList(
            depotList.map((item) =>
    ...
    const handleRemovePengeluaran = (id) => {
        setPengeluaran(pengeluaran.filter((item) => item.id !== id));
    };

    const handlePengeluaranChange = (id, field, value) => {
        setPengeluaran(
    ...
    const handleRemovePenjualan = (id) => {
        setPenjualan(penjualan.filter((item) => item.id !== id));
    };

    const handlePenjualanChange = (id, field, value) => {
        setPenjualan(
            penjualan.map((item) =>
                item.id === id ? { ...item, [field]: value } : item
            )
                    ...
                    <div className="w-full relative">
                        ...
                        <div className="w-full h-full p-6">
                            <form id="TambahKaryawan">
                                ...
                                <div className="w-full flex gap-4 items-start justify-between mt-8">
                                    <div className="w-full bg-white rounded-xl p-6">
                                        <h1 className="font-xl mb-4 font-medium">
                                            Data Depot
                                        </h1>
                                                ...
                                                >
                                                    ...
                                                    depotList.length - 1 ? (
                                                        <svg
                                                            ...
                                                            height="40px"
                                                            viewBox="0 0 24 24"
                                                            className="stroke-blue-500 mb-1 fill-none cursor-pointer active:fill-blue-600 active:stroke-[#f5edea] active:duration-0 duration-300 hover:rotate-90"
                                                            onClick={
                                                                handleAddDepot
                                                            }
                                                        >
                                                        ...
                                                        <svg
                                                            ...
                                                            height="40px"
                                                            viewBox="0 0 24 24"
                                                            className="stroke-red-500 mb-1 fill-none cursor-pointer active:fill-red-600 active:stroke-[#f5edea] active:duration-0 duration-300 hover:rotate-180"
                                                            onClick={() =>
                                                                handleRemoveDepot(
                                                                    item.id
                                                                )
                                ...
                                <div className="w-full mt-8 flex items-center justify-end gap-8">
                                    <button className="rounded-lg relative py-4 px-20 overflow-hidden cursor-pointer flex items-center border border-gray-400 text-gray-400 hover:border-gray-500 hover:text-gray-500 transition-colors ease-in-out duration-200">
                                        Batalkan
                                    </button>
                                    <button
                                        type="submit"
